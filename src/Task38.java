 ...
 * @author a.yusupova
 */
public class Task38 extends javax.swing.JFrame {
...
//                this.canvas1.getWidth(), this.canvas1.getHeight());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Task38.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
